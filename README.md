...
[![Build Status](https://travis-ci.org/RateSetterAus/public-api.svg?branch=master)](https://travis-ci.org/RateSetterAus/public-api)
...
6. If you did everything correct, https://ratesetteraus.github.io/public-api/ will lead to your new docs
...
- Documentation(ReDoc): https://ratesetteraus.github.io/public-api/
- SwaggerUI: https://ratesetteraus.github.io/public-api/swagger-ui/
- Look full spec:
    + JSON https://ratesetteraus.github.io/public-api/swagger.json
    + YAML https://ratesetteraus.github.io/public-api/swagger.yaml
- Preview spec version for branch `[branch]`: https://ratesetteraus.github.io/public-api/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://ratesetteraus.github.io/public-api/ with url from the message: `Server started <url>`
